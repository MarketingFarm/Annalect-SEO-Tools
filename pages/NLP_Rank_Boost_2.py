...
st.markdown(
    ...
    e poi espandere l’accordion sottostante per vedere tutti i dettagli:
    query, People Also Ask, Ricerche Correlate, risultati organici e keyword mining.
    """
)
...
# Accordion con TUTTO ciò che riguarda il JSON
with st.expander("Visualizzazione dati JSON", expanded=False):
