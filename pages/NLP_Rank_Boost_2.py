...
# Imposto lo step iniziale
if 'step' not in st.session_state:
    st.session_state.step = 1

# Callback per avanzare allo step 2
def go_next():
    st.session_state.step = 2

# Step 1: mostra query, organici, PAA e Ricerche Correlate
if st.session_state.step == 1:
    # separator sotto descrizione
  ...
  """
    ...
    # due colonne: organici e PAA+related
...
# Step 2: mostra solo le multiselect per le keywords
